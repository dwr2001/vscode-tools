...
const vscodeListener = async (event: MessageEvent<VscodeEnv | VscodeChatOpen | VscodeChatMessage | VscodeChatClose | VscodeChatError>) => {
...
let client = new SSEClientWithThinkTag(
  baseURL.value,
  thinkTag.value,
  open,
  message,
